...
namespace
{
Glonass_Ca_Dll_Pll_Tracking_cc::GlonassSignalParams params_for_band(GlonassBand band)
{
    switch (band)
        {
        case GlonassBand::L1:
    ...
    float early_late_space_chips)
{
    return glonass_ca_dll_pll_make_tracking_cc(
        fs_in, vector_length, dump, dump_filename, pll_bw_hz, dll_bw_hz, early_late_space_chips, GlonassBand::L1);
}
...
{
    return glonass_ca_dll_pll_make_tracking_cc(
        fs_in, vector_length, dump, dump_filename, pll_bw_hz, dll_bw_hz, early_late_space_chips, GlonassBand::L2);
}
